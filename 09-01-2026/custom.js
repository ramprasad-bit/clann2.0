...
var projectFolder = pathArray[1]; // clann2.0
var siteUrl = window.location.protocol + '//' + window.location.host + '/' + projectFolder + '/';
// console.log(siteUrl);
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.culture-trigger').forEach(item => {
        item.addEventListener('click', function (e) {
            e.preventDefault();
            popupTitle.innerHTML = this.dataset.title;
            popupBody.innerHTML = this.dataset.content;
            popup.hidden = false;
...
// ===== How to apply slider home page-
  ...
  $('#apply-slider').slick({
    ...
    arrows: true,
    infinite: false,
    prevArrow: '<button class="slide-arrow prev-arrow"><img src="'+ siteUrl +'/wp-content/themes/starter_theme/assets/images/arrow-prev.png" aria-hidden="true" alt="previous arrow" /></button>',
    nextArrow: '<button class="slide-arrow next-arrow"><img src="'+ siteUrl +'/wp-content/themes/starter_theme/assets/images/arrow-next.png" aria-hidden="true" alt="next arrow" /></button>',
    adaptiveHeight: true,
    responsive: [
      {
        breakpoint: 1365,
